  ...
  render(){          
    return (
        <div id="BarraFuncionalidades">
          <div id='CaixaAzul'>
            <img src={image}></img>
            <div id="azul"><div id="PesquisaFuncionalidades"><input autofocus id="inputPesquisaFuncionalidades" onBlur={() => this.limpaCampo("inputPesquisaFuncionalidades")}/><span id="pesquisaItens" class="material-icons">search</span></div></div>
          </div>
          <ul>          
